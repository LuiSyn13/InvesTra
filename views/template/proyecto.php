<div class="project">
    <a href="../../controllers/project/p-cerrar_proyecto.php" class="a_home"><img src="../../img/icons_document/home.png" alt=""></a>
    <div class="nav-options-project">
        <a href="datosgenerales.php">Datos Generales</a>
        <a href="alimentar.php">Alimentar</a>
    ...
    <div class="options-export-off" id="submenu-export">
        <div class="sub_export">
            <a href="descargar_proyecto.php" target="_blank">Descargar</a>
            <a href="#">Compartir</a>
        </div>
    </div>
</div>
