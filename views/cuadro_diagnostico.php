...
<?php
    ...
    <tr>
    <th style="background: #d3d3d3; color: black" height="50" ><center>Síntomas</center></th> 
    <th style="background: #d3d3d3; color: black" ><center>Causas</center></th>
    <th style="background: #d3d3d3; color: black"><center>Pronóstico</center></th>
    <th style="background: #d3d3d3; color: black"><center>Control de pronóstico</center></th>
    </tr>             
     <tr>
    <td>
