...
$sql_in = "SELECT a.*, tp.*,u.*,n.*,p.*,i.*
            FROM antecedentes a, tipoantecedente tp, universidad u, nacionalidad n, proyecto p, investigador i
            WHERE a.idtipoantecedente = tp.idtipoantecedente
            AND a.iduniversidad = u.iduniversidad
...
$texto = "          ".$r_in["autor"]." (".$r_in["año"]."), realizó su investigación llamada: ''".$r_in["titulo"]."''. El objetivo general de la investigación fue: ''".$r_in["objetivog"]."''. La tesis fue realizada para obtener el grado de ''".$r_in["grtitulo"]."'' en ".$r_in["nomuniversidad"].", ".$r_in["nomnacionalidad"].".
...
// Texto formateado según APA 7, justificado
$pdf->SetFont('Times', '', 12);
$texto = "          ".$r_na["autor"]." (".$r_na["año"]."), realizó su investigación llamada: ''".$r_na["titulo"]."''. El objetivo general de la investigación fue: ''".$r_na["objetivog"]."''. La tesis fue realizada para obtener el grado de ''".$r_na["grtitulo"]."'' en ".$r_na["nomuniversidad"].", ".$r_na["nomnacionalidad"].".
...
// Texto formateado según APA 7, justificado
$pdf->SetFont('Times', '', 12);
$texto = "          ".$r_lo["autor"]." (".$r_lo["año"]."), realizó su investigación llamada: ''".$r_lo["titulo"]."''. El objetivo general de la investigación fue: ''".$r_lo["objetivog"]."''. La tesis fue realizada para obtener el grado de ''".$r_lo["grtitulo"]."'' en ".$r_lo["nomuniversidad"].", ".$r_lo["nomnacionalidad"].".
