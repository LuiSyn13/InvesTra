                    ...
                    <td>
                        ...
                        <form action="">
                            <div class="content-form-alimentar" style="padding: 1.7em; background: white; flex-direction: column;">
                                ...
                                <br>
                                <textArea onkeydown="cancelar()" name="txtproblemagen" class="txtArea_poh" placeholder=""></textArea>
                                <br>
                                <div class="descripcion-container">
                                ...
                                <br>
                                <textArea name="txtproblemasesp" class="txtArea_desc" style="height: 170px" placeholder="<?php for ($i = 1; $i <= 9; $i++) echo "Hipótesis esp. 0$i" . "\n"; ?>"></textArea>
                            </div>
                    </td>
                </tr>
                <tr>
