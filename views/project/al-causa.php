                    ...
                    <td>
                        ...
                        <form action="../../controllers/project/p-alimentar.php" method="post">
                            <div class="content-form-alimentar" style="padding: 1.7em; background: white; flex-direction: column;">
                                ...
                                <br>
                                <textarea name="txtalimentar" class="txtArea_desc" placeholder="<?php for ($i = 1; $i <= 9; $i++) echo "Causa 0$i" . "\n"; ?>"><?php
                                $sqlA = "SELECT*FROM aporte WHERE idproyecto = $idProject AND idtipoaporte = 2";
                ...
                <tr>
                    <td>
                        <div class="btn_gdata_card">
                            <input type="hidden" name="tipo_aporte" value="2">
