                        ...
                        ?>
                                <div class="content_msn_projet">
                                    ...
                                    <div class="options_msn_project">
                                        <a href="../../controllers/asesor/p-inicio.php?id=<?php echo $r["idrevision"]."&est=".$estre;?>" class="option_msn" style="background: <?php echo $bgre;?>"><?php echo $text;?></a>
                                        <a href="../../controllers/asesor/p-inicio.php?id=<?php echo $r["idrevision"]."&est=".$estom;?>" class="option_msn" style="background: <?php echo $bgom;?>"><?php echo $textom;?></a>
                                    </div>
                                </div>
                        <?php
                            }
